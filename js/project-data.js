const projectsData = {
  ...
  "juventus": {
    ...
    intro:
      "Personal project. Alternative visual directions for Juventus's social media presence.",
    intro_it:
      "Progetto personale. Direzioni visive alternative per la presenza social della Juventus.",
  ...
  "stefano-francioni": {
    ...
    intro:
      "Online and offline communication for an Italian theater production company.",
    intro_it:
      "Comunicazione online e offline per una compagnia italiana di produzioni teatrali.",
    ...
    body: [
      "A collection of projects created during my collaboration with Stefano Francioni Produzioni, an Italian theater production company. The work spans both online and offline communication, from social media content to print materials, always balancing artistic direction with the visual identity of each production.",
    ],
    body_it: [
      "Una raccolta di progetti realizzati durante la mia collaborazione con Stefano Francioni Produzioni, una compagnia italiana di produzioni teatrali. Il lavoro copre sia la comunicazione online che offline, dai contenuti social ai materiali da stampa, bilanciando sempre la direzione artistica con l'identità visiva di ogni produzione.",
    ],
...

  {
    ...
    gallery: [
      ...
      {
        type: "text",
        title: "Giorgio Pasotti",
        text: "Social media package for Giorgio Pasotti, themed around his show 'Io, Shakespeare e Pirandello'.",
        text_it: "Pacchetto social media per Giorgio Pasotti, a tema con il suo spettacolo 'Io, Shakespeare e Pirandello'."
      },
      {
        type: "group",
        images: [
...
{ image: "assets/optimized-files/optimized/covince/journey-dashboard/Final Layout.webp", text: "" },
  ...
  "gorgeous": {
    ...
    title: "Gorgeous - Blu-Ray",
    category: "Blu-Ray Design",
    intro:
      "Commissioned Blu-ray cover design for the martial arts romance film Gorgeous, starring Jackie Chan.",
    intro_it:
      "Design di copertina Blu-ray su commissione per il film romantico di arti marziali Gorgeous, con Jackie Chan.",
    ...
    tools:
      "Adobe Photoshop,<br>Illustrator",
...
gallery: [
  ...
  "carousels": {
    ...
    category: "Social Media Design",
    intro:
      "Carousels designed for various clients, with a focus on clean visuals and marketing effectiveness.",
    intro_it:
      "Caroselli progettati per vari clienti, con focus su visual puliti ed efficacia marketing.",
    ...
    body: [
      "Instagram carousels for various clients. The goal was to create content that works both as a communication tool and as a visual artifact, mixing strong typography and layout with content strategy.",
    ],
    body_it: [
      "Caroselli Instagram per vari clienti. L'obiettivo era creare contenuti che funzionassero sia come strumento di comunicazione che come artefatto visivo, mescolando una forte tipografia e layout con la strategia dei contenuti.",
    ],
  ...
  "seventh": {
    ...
    body: [
      "The Seventh Peak is a 3D action game concept where you play as a climber trying to prove to yourself that you're still good at it after a tragic event happened in your life. Game's main goal is to climb seven challenging mountains. The genre of the game is action - platform, where you mix those genres to progress through the levels (mountains). The game is set in a modern era and the style is rough and dull.",
    ],
    body_it: [
      "The Seventh Peak è un concept di gioco d'azione 3D in cui si interpreta un arrampicatore che cerca di dimostrare a se stesso di essere ancora capace dopo un evento tragico nella sua vita. L'obiettivo principale del gioco è scalare sette montagne impegnative. Il genere è action-platform, in cui si mescolano questi generi per progredire nei livelli (le montagne). Il gioco è ambientato in un'era moderna con uno stile grezzo e cupo.",
    ],
